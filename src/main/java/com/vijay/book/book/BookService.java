...
import com.vijay.book.file.FileStorageService;
import com.vijay.book.history.BookTransactionHistory;
import com.vijay.book.history.BookTransactionHistoryRepository;
...
public class BookService {
    ...
    public Integer approveReturnBorrowBook(Integer bookId, Authentication connectedUser) {
        ...
        BookTransactionHistory bookTransactionHistory = bookTransactionHistoryRepository.findByBookIdAndOwnerId(bookId, user.getId())
                .orElseThrow(() -> new OperationNotPermittedException("the book is not return yet, so u cannot approve its return"));
